    ...
    \begin{block}{Conexidade em grafos dinâmicos}
     O problema da conexidade em grafos dinâmicos visa uma implementação eficiente dos métodos da biblioteca abaixo:
      ...
      \begin{shaded}
        ...
        é o número de vértices do grafo $G$. Uma aresta, ao ser inserida em $G$, começa com o nível $\left\lceil \lg n \right\rceil$. Os seguintes invariantes são mantidos:
