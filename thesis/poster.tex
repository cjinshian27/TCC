  ...
  \begin{columns}[T]
    ...
    \begin{block}{Conexidade em grafos dinâmicos}
      ...
      \begin{shaded}
        ...
        Seja $G$ um grafo com conjunto $V(G)$ de vértices e conjunto $E(G)$ de arestas. Temos $G_i$ = $G[X]$ o grafo onde $X$ é o conjunto das arestas do grafo $G$ de nível menor ou igual a $i$. Para cada nível $i$, manteremos uma floresta maximal $F_i$ de $G_i$. Assim, manteremos $\left\lceil \lg n \right\rceil$ florestas dinâmicas do grafo $G$. Além disso, manteremos também, para cada nível $i$, um grafo $R_i$ em forma de listas de adjacências, que guardam apenas arestas de nível $i$ que não estejam em $F_i$.
      \end{shaded}
    \end{block}
    ...
    \begin{block}{Referências}
      ...
      \begin{thebibliography}{30}
          ...
          \bibitem{tarjan}
          Tarjan, R. E., Vishkin, U.,
          ``\textbf{An efficient parallel biconnectivity algorithm},''
          \textit{SIAM Journal on Computing}, 14(4): 862--874, 1985.

          \bibitem{sleator}
          Sleator, D. D., Tarjan, R. E.,
          ``\textbf{Self-adjusting binary search trees},''
          \textit{Journal of the ACM}, 32(3): 652--686, 1985.
          ...
          \bibitem{henzinger_king}
          Henzinger, M. R., King, V.,
          ``\textbf{Randomized dynamic graph algorithms with polylogarithmic time per operation},''
          in \textit{Proceedings of the 27th Annual ACM Symposium on Theory of Computing (STOC '95)},
          Las Vegas, USA, 1995, pp. 519--527.
