...
\end{shaded}
    ...
    Abaixo temos uma simplificação do código da remoção de uma aresta do grafo. Observe que as Euler tour trees carregam informação extra para que a implementação das linhas $7$, $8$, $12$ e $13$ sejam eficientes. 
