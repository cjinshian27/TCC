      ...
      \begin{figure}[H]
          ...
          \begin{minipage}{\textwidth} 
              ...
              \begin{tikzpicture}
                    ...
                    \node at (-4, 0.9) {\textcolor{blue}{Euler tour}};
                    \node at (-4, 0) {\textcolor{blue}{tree de $T$}};
              \end{tikzpicture}
...
\end{figure}
    ...
    \begin{block}{}
      ...
      Na figura abaixo, veja que, nas linhas $11$ e $14$, passamos a procurar uma aresta de peso mínimo em $R_i$ incidente a $T_u$. Note também que as linhas $1$ ao $9$ são idênticas às do método \texttt{substituaAresta}.
