...
\end{figure}
    ...
    \begin{block}{}
      ...
      Na figura abaixo, veja que, nas linhas $11$ e $14$, passamos a procurar uma aresta de peso mínimo em $R_i$ incidente a $T_u$. As linhas $1$ ao $9$ são idênticas às do método \texttt{substituaAresta}.
