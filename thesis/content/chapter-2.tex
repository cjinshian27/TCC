...
Até o momento, mostramos que arestas reserva de nível $i$ com as duas pontas em $T_u$ possuem peso menor ou igual ao peso das arestas reserva de nível $i+1$ com as duas pontas em $T_u$.  
No caso das arestas reserva com uma ponta incidente a $T_u$ e outra em $T_v$, nenhuma chega a ser rebaixada, visto que a de menor peso já se tornaria uma aresta da floresta e as outras não seriam afetadas. Por fim, as arestas reserva de $T_v$ não são afetadas visto que nenhuma delas reconectam as componentes separadas.
