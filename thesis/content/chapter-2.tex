...
Geralmente, usamos o algoritmo de Kruskal (e o de Prim também) em grafos que não sofrem adição ou remoção de arestas com o passar do tempo, visto que queremos saber apenas o custo da MST. Sendo assim, como em Kruskal não há suporte para alterações no grafo, toda vez que removemos uma aresta temos que reconstruir a MST correspondente ao grafo novo. Pelo fato de a ordenação das arestas de $G$ ser a parte que consome mais tempo no algoritmo ($\Oh(m \lg m)$), então toda vez que removemos alguma aresta, o algoritmo de Kruskal terá que reordenar as arestas restantes e construir um novo MST para $G$.
