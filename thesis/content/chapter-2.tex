...
Ainda na mesma imagem, a aresta \textit{bc} está prestes a ser removida, o que acabaria quebrando uma componente da floresta $F_i$ em $T_u'$ e $T_v'$. Veja que, para reconectar $T_u'$ e $T_v'$, percorreríamos as seguintes arestas reserva, nesta ordem: $ub$,  $uc$ e $ac$. Veja que, embora a $ac$ seja uma substituta, a $uc$ seria escolhida em seu lugar por ser a de menor peso, e está em $R_i$. 
