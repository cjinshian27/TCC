...
\begin{itemize}
    ...
    \item \texttt{\textbf{extraiaPesoMSF(G, u, v)}}: devolve o peso da MSF do grafo ponderado $G$;
...
A invariante~\ref{invariant11} é preservada para o nível $i = \left\lceil \lg n \right\rceil$. Como estamos inserindo arestas no nível $\left\lceil \lg n \right\rceil$ em $F_{\left\lceil \lg n \right\rceil}$, então as florestas de níveis inferiores não são afetadas, mantendo-se, assim, as invariantes~\ref{invariant22} e \ref{invariant33} também.
