...
Para descrever a rotina \texttt{substituaArestaMSF}, que está descrita no Programa~\ref{prog:replaceMSF} abaixo, usaremos vários dos métodos auxiliares já apresentados, além da Seção~\ref{sec:forest-node-adjustments}, onde adicionamos campos novos aos nós das florestas, que serão fundamentais para que \texttt{substituaArestaMSF} funcione corretamente e de forma eficiente.Mostraremos também a rotina \texttt{testeSubstitutaMSF}, que contém um pequeno ajuste em relação ao \texttt{substituaAresta} que vimos anteriormente. 
