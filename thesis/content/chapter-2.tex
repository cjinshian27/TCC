...
Agora, veremos em detalhes o motivo de não precisarmos procurar uma substituta de menor peso em níveis maiores que $i$ quando removemos uma aresta $uv$ de nível $i$. 
