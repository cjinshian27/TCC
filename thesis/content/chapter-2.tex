...
Já uma remoção de aresta, executada pelo Programa~\ref{prog:removeGD-version-msf-final-version}, custa $\Oh(\lg^2 n)$ mais o custo do \texttt{substituaArestaMSF}. O custo do \texttt{substituaArestaMSF} é $\Oh(\lg^2 n)$ excluindo-se as execuções das linhas $7$ a $10$ do Programa~\ref{prog:replaceMSF}, assim como as linhas $7$ a $14$ do Programa~\ref{prog:find-substitute-MSF}. Desconsiderando estas linhas onde ocorrem rebaixamentos de arestas, cada iteração do para da linha $2$ do Programa~\ref{prog:replaceMSF} possui custo $\Oh(\lg n)$ enquanto uma aresta substituta não for encontrada, ou seja, excetuando as linhas $15$ a $23$ do Programa~\ref{prog:find-substitute-MSF}. 
