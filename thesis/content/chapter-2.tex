...
\begin{programruledcaption}{\texttt{procureNóIncideArestaDePesoMínimo($R$, $p$)} \label{prog:findMinWeightEdge}}
    \noindent\textbf{Entrada}: Recebe um nó $p$ de uma floresta com o  \textit{arestasReservasDeNível} $> 0$ e as listas de adjacências $R$.
    \\
