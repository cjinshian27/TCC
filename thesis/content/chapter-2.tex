...
Ainda na Figura~\ref{fig:why-not-get-replacement-in-higher-levels-2}, a aresta \textit{bc}, de nível $i$, está prestes a ser removida, o que acabaria quebrando uma componente da floresta $F_i$ em $T_b$ e $T_c$. Para reconectar $T_b$ e $T_c$, observe que apenas $uc$ seria percorrida e já é substituta. Embora $ac$ e $cv$ também sejam substitutas incidentes a $T_c$, pelo fato de elas estarem em $R_{i+1}$ e pela invariante~\ref{invariant44}, elas são mais pesadas que $uc$, que está em $R_i$.
