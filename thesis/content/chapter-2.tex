...
Quando inserimos uma aresta reserva $uv$ em $R_L$, precisamos atualizar o atributo \textit{pesoMínimo} dos nós de vértice $u$ e $v$ de $F_L$. Isso porque se o peso de $uv$ é o menor dentre todas as arestas reserva inseridas até o momento, então o atributo \texttt{pesoMínimo} de $u$ e de $v$ passa a ser o peso de $uv$. 
