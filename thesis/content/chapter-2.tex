...
Agora, veremos em detalhes o motivo de não precisarmos procurar primeiro uma substituta de menor peso em níveis $> i$ quando removemos uma aresta $uv$ de nível $i$. 
