...
Logo na imagem abaixo, temos a aresta $ad$ escolhida como uma substituta de menor peso que reconecta $T_u$ e $T_v$, tornando-se uma aresta da floresta. Note que, em $R_i$, as arestas reserva com as duas pontas em $T_u$ de $F_i$ (neste caso, $ub$ e $uc$) possuem peso menor que as arestas reserva com duas pontas em $T_u$ de $F_{i+1}$ (meste caso, $ac$). Isso acontece porque rebaixamos as aresta reserva com as duas pontas em $T_u$ em ordem crescente de peso até encontrarmos uma que conecte $T_u$ e $T_v$.
