...
Agora, veremos em detalhes o motivo de não começarmos a procurar primeiro uma aresta substituta nos níveis $> i$ quando removemos uma aresta $uv$ de nível $i$. Será que que não há uma aresta substituta no nível $i + 1$ que seja mais leve que uma substituta do nível $i$? 
