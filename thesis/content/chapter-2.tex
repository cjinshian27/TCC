...
Como se pode ver, o Programa~\ref{prog:updateMinWeight} consome tempo amortizado $\Oh(\lg n)$ por conta da operação \texttt{splay}. Além disso, ele não altera a floresta $F$, altera somente a forma de uma das árvores binárias que a representam. Portanto, todas as três invariantes são preservadas.
