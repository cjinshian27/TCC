...
A remoção de arestas também é semelhante à do algoritmo de conexidade em grafos dinâmicos. A diferença é que a busca por alguma aresta substituta agora é por ordem de peso das arestas reserva. Quando removemos uma aresta $uv$ da floresta, procuramos por alguma substituta de peso mínimo global dentre todas as reserva, de modo a manter o peso da MST do grafo e ainda reconectar as duas componentes separadas devido à remoção de $uv$. 
