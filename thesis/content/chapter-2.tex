...
Como a remover arestas e ao mesmo tempo manter a MST de um grafo com as arestas restantes é ineficiente no algoritmo de Kruskal, iremos introduzir uma solução eficiente para este problema: o algoritmo decremental para florestas geradoras maximais de custo mínimo (MSF, de \textit{Minimum Spanning Forest}). Iremos abreviar este algoritmo para \textbf{MSF decremental}, e o explicaremos mais em detalhes nas seções seguintes.
