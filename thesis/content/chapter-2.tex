...
Podemos notar algumas diferenças quando comparamos o construtor \texttt{MSFDecremental} com o \texttt{grafoDinâmico}. Na MSF decremental, ordenamos arestas do conjunto $E$ em ordem crescente e inserimos uma a uma chamando \texttt{adicioneMSF}, que está descrito abaixo.
...
O corpo do método \texttt{conectadosMSF}, que está descrito abaixo, é igual ao do \texttt{conectadosGD}. Mudamos somente o nome para ficar coerente com os nomes dos métodos da biblioteca da MSF decremental. 
