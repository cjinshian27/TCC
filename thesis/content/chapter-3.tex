...
\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption{Uma top árvore $\mathcal{T}$ derivada da árvore $T$. Cada vértice (cluster) de $\mathcal{T}$ guarda a união dos vértices dos filhos, que também são clusters. Emabaixo de cada vértice $p$ de $\mathcal{T}$, temos os vértices da fronteira do $p$.}
