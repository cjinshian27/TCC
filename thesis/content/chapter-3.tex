...
A partir da árvore $T$, podemos derivar uma \textit{top tree} na Figura~\ref{fig:top-t-from-tree-t} abaixo. 
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \node[node, shape=ellipse] (ad) at (0, 0) {$a, b, c, d, e, f, g, h, i, j$};
        \node[node, shape=ellipse] (ab) at (-4.5, -1.5) {$a, b, c, d$};
        \node[node, shape=ellipse] (cd) at (4.5, -1.5) {$e, f, g, h, i$};
        \node[node, shape=ellipse] (dc) at (3, -3) {$dc$};
        \node[node, shape=ellipse] (dd) at (1.5, -4.5) {$dd$};
        \node[node, shape=ellipse] (cc) at (4.5, -4.5) {$cc$};
        
        
        \node[node,shape=ellipse] (da) at (6, -3) {$da$};
        \node[node, shape=ellipse] (ae) at (7.5, -4.5) {$ae$};
        
        
        \node[node, shape=ellipse] (ea) at (-6, -3) {$ea$};
        \node[node, shape=ellipse] (ee) at (-7.5, -4.5) {$ee$};
        \node[node, shape=ellipse] (aa) at (-4.5, -4.5) {$aa$};


        \node[node, shape=ellipse] (bb) at (-3, -3) {$bb$};
        \node[node, shape=ellipse] (ba) at (-1.5, -4.5) {$ba$};
