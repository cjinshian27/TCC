...
Além disso, se $R$ é uma subárvore de $S$, isto é, $\partial_{(S, \partial_{(T, \partial T)}S)}R = \partial_{(T, \partial T)} R$, então $R$ é um cluster  
 ...
 \begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \coordinate (DR2) at ([xshift=-17pt, yshift=-16pt]a.north west); 
        ...
        \coordinate (DR4) at ([xshift=17pt, yshift=14pt]d.south east); 
        ...
        % \draw[dashed, thick, red] (e) -- (a) -- (d) -- cycle;
    \end{tikzpicture}
    \caption{Representação de uma árvore $T$ de $5$ vértices. Os vértices pintados em vermelho são vértices da fronteira de $T$, ou seja, formam o conjunto $\partial T$. A região demarcada em vermelho representa a subárvore $S$, que é cluster de $T$, e contém os vértices $a$, $e$ e $d$ e as arestas $ae$ e $ad$. Já a região demarcada em verde representa a subárvore $R$ contendo os vértices $a$ e $d$ e a aresta $ad$, e logo é cluster de $S$ e de $T$.}
