...
\begin{figure}[H]
    ...
    \caption{Tabela de comparação de performance entre os algoritmos de Kruskal e de MSF decremental, com o valor do peso da MST após cada remoção de lote de arestas.}
