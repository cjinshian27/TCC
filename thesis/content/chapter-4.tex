...
\subsection{Primeira permutação de arestas}

\begin{figure}[H]
    \centering
    \includegraphics[width=11cm]{./figuras/performance_table_graph_0_permutation_0.png}
    \caption{Tabela comparando a performance entre os algoritmos de Kruskal e de MSF decremental, exibindo o valor do peso da MST após a remoção de cada lote de arestas.}
...
\begin{figure}[H]
    ...
    \caption{Gráfico comparando a performance entre os algoritmos de Kruskal e de MSF decremental.}
    \label{fig:graph_g0_permutation0}
\end{figure}
\subsection{Segunda permutação de arestas}

\begin{figure}[H]
    \centering
    \includegraphics[width=11cm]{./figuras/performance_table_graph_0_permutation_1.png}
    \caption{Tabela comparando a performance entre os algoritmos de Kruskal e de MSF decremental, exibindo o valor do peso da MST após a remoção de cada de lote de arestas.}
...
\subsection{Terceira permutação de arestas}
...
\subsection{Quarta permutação de arestas}
...
\subsection{Quinta permutação de arestas}
...
\caption{Tempo médio de execução obtido a partir de $5$ permutações de arestas do grafo $G_0$.}
...
\caption{Comparação do tempo médio de execução dos algoritmos de Kruskal e MSF Decremental ao longo de $5$ permutações de arestas do grafo $G_0$.}
