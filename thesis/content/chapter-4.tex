...
O grafo $G_0$ gerado tem 142.069 arestas, que é um número próximo do esperado. A seguir, mostraremos os resultados das remoções em algumas listas de arestas, visto que, visualmente, os valores e o comportamento dos gráficos são muito parecidos. É importante ressaltar que, como o algoritmo derivado de Kruskal consome tempo $O(m)$ por remoção de aresta, optamos por fazer uma compressão de valores dos eixos $x$ e $y$ dos gráficos para evitar a sobreposição dos números, preservando ainda a aparência de crescimento linear.
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos algoritmos de Kruskal e MSF Decremental na permutação $0$ de $G_0$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos algoritmos de Kruskal e MSF Decremental na permutação $1$ de $G_0$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos algoritmos de Kruskal e MSF Decremental na permutação $2$ de $G_0$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos algoritmos de Kruskal e MSF Decremental na permutação $3$ de $G_0$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos algoritmos de Kruskal e MSF Decremental na permutação $4$ de $G_0$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Comparação do tempo médio de execução dos algoritmos de Kruskal e MSF Decremental ao longo de cinco listas de arestas de $G_0$.}
    \label{fig:graph_g0_average}
\end{figure}

\section{Grafos $G_1$, $G_2$, $G_3$, $G_4$ e $G_5$}

Neste experimento, realizamos os mesmos experimentos de $G_0$, mas usando apenas a primeira permutação de arestas de outros cinco grafos. O grafo $G_1$ foi gerado com $142.589$ arestas; o grafo $G_2$ com $142.954$ arestas; o grafo $G_3$ com $142.734$ arestas; o grafo $G_4$ com $142.402$ arestas; e o grafo $G_5$ com $143.216$ arestas.
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos algoritmos de Kruskal e MSF Decremental na permutação $0$ de $G_1$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos algoritmos de Kruskal e MSF Decremental na permutação $0$ de $G_2$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos algoritmos de Kruskal e MSF Decremental na permutação $0$ de $G_3$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos algoritmos de Kruskal e MSF Decremental na permutação $0$ de $G_4$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos algoritmos de Kruskal e MSF Decremental na permutação $0$ de $G_5$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
