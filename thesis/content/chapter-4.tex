...
As arestas de $F$ são chamadas de \textbf{arestas da floresta globais} e as arestas de $R = G / F$ são chamadas de \textbf{arestas reserva globais}. Similarmente, as arestas de $F_i$ são chamadas de \textbf{arestas da floresta locais} e as arestas de $R_i = G_i / F_i$ de \textbf{arestas reserva locais}. Além disso, todas as arestas de $G$ estarão em alguma $G_i$, de modo que $F \subseteq \bigcup_i F_i$.
...
Já para remover uma aresta $uv$, primeiramente removemos todas as ocorrências desta aresta em $G_i$.
