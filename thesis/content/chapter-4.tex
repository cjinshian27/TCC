...
Neste experimento, realizamos os mesmos experimentos de $G_0$, mas usando apenas a primeira lista aleatória de arestas de outros cinco grafos. Isso porque vimos na Seção~\ref{section:graph0} que os resultados entre as diferentes listas aleatórias de um mesmo grafo são bem parecidos.

O grafo $G_1$ tem gerado com $142.589$ arestas; o grafo $G_2$ tem $142.954$ arestas; o grafo $G_3$ tem $142.734$ arestas; o grafo $G_4$ tem $142.402$ arestas; e o grafo $G_5$ tem $143.216$ arestas.
