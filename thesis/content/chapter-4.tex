...
\begin{figure}[H]
    ...
    \caption{Desempenho dos dois algoritmos na permutação $0$ de $G_0$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Desempenho dos dois algoritmos na permutação $0$ de $G_0$.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos dois algoritmos na permutação $1$ de $G_0$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Desempenho dos dois algoritmos na permutação $1$ de $G_0$.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos dois algoritmos na permutação $2$ de $G_0$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Desempenho dos dois algoritmos na permutação $2$ de $G_0$.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos dois algoritmos na permutação $3$ de $G_0$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Desempenho dos dois algoritmos na permutação $3$ de $G_0$.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos dois algoritmos na permutação $4$ de $G_0$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Desempenho dos dois algoritmos na permutação $4$ de $G_0$.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos dois algoritmos na permutação $0$ de $G_1$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Desempenho dos dois algoritmos na permutação $0$ de $G_1$.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos dois algoritmos na permutação $0$ de $G_2$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Desempenho dos dois algoritmos na permutação $0$ de $G_2$.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos dois algoritmos na permutação $0$ de $G_3$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Desempenho dos dois algoritmos na permutação $0$ de $G_3$.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos dois algoritmos na permutação $0$ de $G_4$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Desempenho dos dois algoritmos na permutação $0$ de $G_4$.}
...
\begin{figure}[H]
    ...
    \caption{Desempenho dos dois algoritmos na permutação $0$ de $G_5$, exibindo o peso de uma MST após a remoção de cada lote de arestas.}
...
\caption{Desempenho dos dois algoritmos na permutação $0$ de $G_5$.}
