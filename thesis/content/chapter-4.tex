...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./figuras/graph_0_permutation_0.png}
    \caption{Remoção de 25.600 arestas da primeira permutação de arestas de $G_0$.}
    \label{fig:graph_g0_permutation0}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./figuras/performance_table_graph_0_permutation_0.png}
    \caption{Tabela de comparação de performance entre os algoritmos de Kruskal e de MSF decremental, com o valor do peso da MST após a remoção de cada lote de arestas.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./figuras/graph_0_permutation_0.png}
    \caption{Remoção de 25.600 arestas da segunda permutação de arestas de $G_0$.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./figuras/performance_table_graph_0_permutation_0.png}
    \caption{Tabela de comparação de performance entre os algoritmos de Kruskal e de MSF decremental, com o valor do peso da MST após a remoção de cada de lote de arestas.}
