...
Neste experimento, realizamos os mesmos experimentos de $G_0$, mas usando apenas a primeira lista aleatória de arestas de outros cinco grafos. Isso porque vimos na Seção~\ref{section:graph0} que os resultados entre as diferentes listas aleatórias de um mesmo grafo são bem parecidos. Por isso, focamos no desempenho dos dois algoritmos em grafos aleatórios distintos.
