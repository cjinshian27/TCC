...
Por fim, seria interessante apresentar os detalhes de como implementar a biblioteca deste algoritmo para MSF dinâmica. Para isso, entretanto, precisaríamos modificar a implementação dos algoritmo da conexidade em florestas dinâmicas, que passaria a usar top trees no lugar de Euler tour trees. Como a nossa implementação da biblioteca de Euler tour trees possui um consumo de tempo diferente das Top trees apresentadas em Holm, de Lichtenberg e Thorup~\cite{jacob_holm}, a biblioteca que implementamos do algoritmo de conexidade em grafos dinâmicos teria a sua complexidade de tempo alterada, visto que este passaria a manter componentes destas florestas dinâmicas ajustadas. 

Além disso, ajustes na biblioteca do algoritmo de conexidade alteraria, por sua vez, o consumo de tempo da biblioteca que implementamos do algoritmo para MSF decremental. É após esses ajustes que, finalmente, poderíamos implementar um algoritmo para a MSF dinâmica proposta por Holm, de Lichtenberg e Thorup~\cite{jacob_holm} na Seção~$5$ de seu artigo. 
