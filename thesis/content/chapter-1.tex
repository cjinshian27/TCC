...
\begin{figure}[H]
    ...
    \begin{minipage}[c]{0.8\textwidth}
        ...
        \end{tikzpicture}
    \end{minipage}
    \caption{Representação da busca pela aresta substituta em $T_u$ de $R_4$. As arestas reservas de nível $4$, inteiramente contidas em $T_u$, estão prestes a ser removidas de $R_4$ e foram rebaixadas para $R_3$.}
    \vspace{-1cm}
