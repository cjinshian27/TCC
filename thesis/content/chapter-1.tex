...
O Programa~\ref{prog:updateIsLevelCount-GD} consome tempo $\Oh(\lg n)$ e Programa~\ref{prog:updateIsLevelCount-GD-splay} consome tempo amortizado $\Oh(\lg n)$. Já o Programa~\ref{prog:updateIsLevel-GD}, em nossa implementação, consome tempo amortizado $\Oh(\lg n)$, já que ele aciona o Programa~\ref{prog:updateIsLevelCount-GD-splay}. Veja que ambos os programas não alteram a árvore e, portanto, todas as três invariantes são preservadas. 
