...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node[node] (h) at (5, 3.7) {h};
         ...
         % Dotted circles for T_u and T_v
        \draw[dotted, thick, gray] (-3,2) circle (3cm);
        \draw[dotted, thick, gray] (4,2) circle (3cm);  
...
Assim, nota-se que é necessário uma implementação mais eficiente para a rotina de remoção de arestas, e  por isso apresentaremos a solução de Holm, de Lichtenberg e Thorup~\cite{jacob_holm}, que resolve este problema em O(lg$n^2$).
