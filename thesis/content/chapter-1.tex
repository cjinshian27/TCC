...
\begin{programruledcaption}{\texttt{rebaixeNívelDaAresta($G$, $\textit{nó}$, $l$)} \label{prog:decrease-edge-level}}
    \noindent\textbf{Entrada}: Recebe o grafo $G$, um nó de aresta e o nível $l$.\\
    ...
    nó.éNível := falso
    \texttt{atualizeArestasDeNível($F_j$, $x$, $y$)}
