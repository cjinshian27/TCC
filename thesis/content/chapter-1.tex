...
Já uma remoção de aresta, executada pelo Programa~\ref{prog:removeGD-version2}, custa $\Oh(\lg^2 n)$ mais o custo do \texttt{substituaAresta}. O custo do \texttt{substituaAresta} é $\Oh(\lg^2 n)$ excluindo-se as execuções das linhas $7$ a $10$ do Programa~\ref{prog:replaceGD}, assim como as linhas $4$ a $9$ do Programa~\ref{prog:find-substitute}. Desconsiderando estas linhas onde ocorrem rebaixamentos de arestas, cada execução da linha $2$ do Programa~\ref{prog:replaceGD} possui custo $\Oh(\lg n)$ nas linhas restantes. 
