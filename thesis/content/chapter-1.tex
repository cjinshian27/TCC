...
\begin{itemize}
    \item \texttt{\textbf{listaDeAdjacências(n)}}: constrói e devolve um grafo com $n$ vértices e sem arestas contendo $n$ listas de adjacências, onde $n$ é o número de vértices isolados;
