...
\begin{itemize}
    \item \texttt{\textbf{florestaDinâmica(n)}}: constrói e devolve uma floresta dinâmica $F$ com $n$ vértices sem arestas ;
...
\begin{itemize}
    \item \texttt{\textbf{grafoDinâmico(n)}}: contrói e devolve um grafo dinâmico com $n$ vértices sem arestas ;
...
\begin{itemize}
    \item \texttt{\textbf{listaDeAdjacências(n)}}: constrói e devolve um grafo $R$ contendo $n$ listas de adjacências, onde $n$ é o número de vértices isolados;
...
\begin{programruledcaption}{\texttt{grafoDinâmico(n)} \label{prog:newGD}}
    ...
    \textbf{Saída}: Devolve um grafo dinâmico $G$ com $n$ vértices sem arestas .
